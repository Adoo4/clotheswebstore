...
let Bottoms = ({user, setuser}) => {
  ...
  let addItem = async () => {
      try {
          ...
          let response = await axios.post("http://localhost:5757/bottoms/bottoms", newArticle);
  ...
  let deleteItem = async (item) => {
      try {
          ...
          const response = await axios.delete(`http://localhost:5757/bottoms/deletebottoms/${item._id}`);
  ...
  let editItem = async (id) => {
      ...
      try {
          let response = await axios.put("http://localhost:5757/bottoms/editbottom", toEdit)
                ...
                {dataAll.map((e, index) => (
                    <Grid item xs={4} sm={4} md={4} key={index}>
                        ...
                        <Card sx={{ maxWidth: 345, padding: "1rem" }}>
                            ...
                            <CardMedia
                                sx={{
                                    height: 170, padding: "1rem", height: 350, 
                                    width: "100%" 
                                    , padding: "0.5rem", 
                                    objectFit: "cover"
                                }}
